...
function fancySize(size: number): string {
  return (size / 1232896).toFixed(1) + 'MB';
}

async function update(version: Version, test?: boolean) {
...
function getFullVersionName(version: Version) {
...
async function getArticle(version: Version): Promise<{ url?: string; title?: any; subtitle?: any; image?: string; }> {
